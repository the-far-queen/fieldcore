...
# Proposal 04 — Schauberger Vortex Engineering

**Original Number:** 04 (Set 1)
...
**Claim**: Vortex motion in egg/hyperbolic geometry produces measurable energy concentration (4 mechanisms: geometric, Unruh, parametric, MHD).

**Experiment** (summary):
- Build egg-geometry vortex device
- Measure energy concentration vs. circular-pipe control
- Test 4°C water optimal state

**Funding required** (summary):
- See breakdown below.
- **Total:** $1,000,000

**Academic fields**: fluid dynamics, vortex engineering.
...
1. Build egg-geometry vortex device.
2. Measure energy concentration vs. circular-pipe control.
3. Test 4°C water optimal state.

## Funding breakdown

- **Vortex device fabrication:** $100,000
- **Instrumentation:** $200,000
- **Personnel (PhD + postdoc, 4 years):** $700,000
...
- **Mechanical hazards:** pressurised vessels, moving impellers, rotating shafts. Pressure relief valves, burst discs, mechanical guards; lockout-tagout during maintenance; witness stand-off during high-speed operation.
