...
# Proposal 06 — Prime Fractals alpha Derivation

**Original Number:** 06 (Set 1)
...
**Claim**: alpha^-1 = 137.036 sits at the intersection of the prime fractal and Fibonacci fractal on S^3. FieldCore may offer the first geometric derivation.

**Experiment** (summary):
- Compute prime-Fibonacci intersection geometry
- Verify alpha^-1 falls within the intersection
...
**Academic fields**: mathematical physics, number theory.
...
1. Compute prime-Fibonacci intersection geometry.
2. Verify alpha^-1 falls within the intersection.
3. Derive alpha from first principles.

## Funding breakdown

- **Computational physicist:** $200,000/year × 3 years
- **High-performance compute:** $50,000
...
Standard laboratory safety applies. No novel hazards beyond standard physics/biology/AI research. IRB approval if human subjects; IACUC if vertebrate animals; biosafety review if biological agents; radiation safety if ionising sources.
