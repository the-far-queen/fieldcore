...
# Proposal 02 — Mercury Room-Temperature Quantum Coherence

**Original Number:** 02 (Set 1)
...
**Claim**: Mercury at 25°C has cell-scale quantum coherence (~1 μm) measurable via STM.

**Experiment** (summary):
- STM measurement of mercury surface at 25°C
- Compare coherence lengths at different temperatures
- Verify Z=80 atomic structure via XPS

**Funding required** (summary):
- See breakdown below.
- **Total:** $1,100,000

**Academic fields**: condensed matter, quantum measurement, surface physics.
...
1. STM measurement of mercury surface at 25°C.
2. Compare coherence lengths at different temperatures.
3. Verify Z=80 atomic structure via XPS.

## Funding breakdown

- **STM with ultra-high vacuum:** $800,000
- **Mercury handling:** $10,000
- **Personnel (PhD student, 3 years):** $300,000
...
- **Mercury toxicity:** elemental Hg is neurotoxic via inhalation of vapour. All mercury handling in a certified fume hood; vapour monitor at <0.05 mg/m^3 TLV; spill kit on hand; personnel trained per OSHA 29 CFR 1910.1200; mercury vacuum cleaner for spills; medical surveillance for exposed staff.
