...
# Proposal 05 — Tesla 137 Hz Cellular Resonance

**Original Number:** 05 (Set 1)
...
**Claim**: 137 Hz acoustic source produces measurable cellular response (calcium signalling, neural firing patterns).

**Experiment** (summary):
- Cell cultures exposed to 137 Hz (and control frequencies)
- Calcium imaging
- Neural firing rate measurement

**Funding required** (summary):
- See breakdown below.
- **Total:** $950,000

**Academic fields**: biophysics, neuroscience, acoustic resonance.
...
1. Cell cultures exposed to 137 Hz (and control frequencies).
2. Calcium imaging.
3. Neural firing rate measurement.

## Funding breakdown

- **Cell culture lab:** $250,000
- **Calcium imaging:** $300,000
- **Personnel (PhD, 4 years):** $400,000
...
- **Biological safety:** cell/tissue culture requires BSL-2 containment; sharps protocols; medical waste disposal; IACUC approval for any animal work.
