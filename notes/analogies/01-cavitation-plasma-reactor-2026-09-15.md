...
# Proposal 01 — Cavitation Plasma Reactor

**Original Number:** 01 (Set 1)
...
**Claim**: Cavitation bubble collapse produces transient plasma conditions (T = 10^4-10^5 K, P = 10^11 Pa) and measurable UV + soft X-ray emission.

**Experiment** (summary):
- Cavitation chamber with high-speed optical + X-ray spectroscopy
- Acoustic driver at 20-100 kHz
- Time-resolved photon detection

**Funding required** (summary):
- See breakdown below.
- **Total:** $600,000

**Academic fields**: plasma physics, sonochemistry, acoustics.
...
1. Cavitation chamber with high-speed optical + X-ray spectroscopy.
2. Acoustic driver at 20-100 kHz.
3. Time-resolved photon detection.

## Funding breakdown

- **Cavitation chamber:** $50,000
- **Spectroscopy:** $150,000
- **Personnel (PhD student, 4 years):** $400,000
...
| 07 | Stalk Architecture v6.1 Implementation | Adjacent substrate physics / engineering |
...
- **Acoustic pressure:** sustained high-amplitude ultrasound (>100 dB SPL) can cause hearing damage and tissue heating. Operators wear hearing protection; acoustic enclosure required; dosimetry on personnel.
- **UV exposure:** UV-C is carcinogenic and causes photokeratitis. Enclosed beam paths; UV-blocking eyewear (DIN 5+); skin coverage; interlocks on open beams.
- **X-ray exposure:** soft X-ray spectroscopy produces ionising radiation. Lead shielding; personal dosimetry; licence per local radiation authority; interlocks on open beams.
