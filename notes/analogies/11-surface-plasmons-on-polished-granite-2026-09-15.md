...
# Proposal 11 — Surface Plasmons on Polished Granite

**Original Number:** 11 (Set 1)
...
**Claim**: Barabar-grade polished granite (roughness < 125 nm) supports UV surface plasmons resonant with water quantum tunnelling.

**Experiment** (summary):
- Obtain or fabricate Barabar-grade polished granite sample
- Measure surface plasmon resonance
- Verify UV frequency at 1-1.5 eV

**Funding required** (summary):
- See breakdown below.
- **Total:** $705,000

**Academic fields**: surface physics, plasmonics.
...
1. Obtain or fabricate Barabar-grade polished granite sample.
2. Measure surface plasmon resonance.
3. Verify UV frequency at 1-1.5 eV.

## Funding breakdown

- **Sample acquisition:** $5,000
- **Spectroscopy equipment:** $400,000
- **Personnel:** $300,000
