...
# Proposal 10 — Twin-Prime Sum Cascade phi-Conjecture

**Original Number:** 10 (Set 1)
...
**Claim**: Twin prime sums form a quasi-phi-convergent cascade. Ratios oscillate around phi.

**Experiment** (summary):
- Compute first 10^6 twin prime sums
...
**Academic fields**: analytic number theory, golden ratio.
...
1. Compute first 10^6 twin prime sums.
2. Compute successive ratios.
3. Fit to phi.

## Funding breakdown

- **Computational number theorist:** $120,000/year × 2 years
- **High-performance compute:** $20,000
